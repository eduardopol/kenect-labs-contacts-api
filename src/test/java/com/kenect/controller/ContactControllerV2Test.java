...
@WebMvcTest(ContactControllerV2.class)
class ContactControllerV2Test {
    ...
    @Test
    void testGetAllContactsV2() throws Exception {
        ...
        when(contactService.getAllContactsAsync()).thenReturn(mockContacts);
